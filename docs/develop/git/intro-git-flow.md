...
-   [一个成功的 Git 分支模型](./success-git-branch-model.md)
...
```sh
# 更新 develop 代码, 保证 develop 代码最新
$ git checkout develop && git pull
$ git flow feature start xxx

# 假定现在 feature 分支已经开发完毕
# 会合并到develop分支
# 检查 远程 feature 分支是否删除, 如果没有, 则需要删除, 保证分支纯洁性
...
```
# 查看最新版本, 创建 hotfix
# 看当前 版本, 新分支在 hotfix 版本之后 +1
$ git tag|sort -V

# 如果当前版本是 2.2.1, 则 hotfix 修复版本为 2.2.2
$ 如果当前版本是 2.28.1.0, 则 hotfix 修复版本为 2.28.1.1
$ git flow hotfix start 2.28.1.1


# 完成分支
$ git flow hotfix finish 2.28.1.1

# 推送分支到 master & develop
```
